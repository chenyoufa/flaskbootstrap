...
def SaveRoleFormJson():
    ...
    if form.validate_on_submit():
        try:
            if form.Id.data<=0:
                role = Role(Name=form.RoleName.data,Sort=form.RoleSort.data,Remark=form.Remark.data,
                Status=form.RoleStatus.data,CreateUserid=session.get('User_Id'),ModifyUserid=0)
